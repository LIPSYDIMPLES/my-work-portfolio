...
export default function ContactCard() {
  ...
  const downloadVCard = () => {
    ...
    link.setAttribute(
      "download",
      `${PERSONAL_INFO.fullName.toLowerCase().replace(/\s+/g, "_")}.vcf`,
    );
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
          ...
          <div className="h-1 w-12 bg-linear-to-r from-emerald-500 to-teal-500 mx-auto rounded-full" />
          <p className="text-zinc-400 text-sm">
            Interested in hiring me, collaborating, or simply discussing tech
            developments? Reach out anytime!
          </p>
        </div>
            ...
            <div className="bg-zinc-950/45 border border-zinc-900 p-6 md:p-8 rounded-3xl shadow-sm space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="grow">
                    <p className="text-[10px] font-semibold text-zinc-500 font-mono uppercase tracking-wider">
                      Email Address
                    </p>
                    <a
                      href={`mailto:${PERSONAL_INFO.email}`}
                      className="text-zinc-150 font-bold hover:text-emerald-450 transition-colors text-sm break-all"
                    >
                      {PERSONAL_INFO.email}
                    </a>
                  </div>
                  ...
                  >
                    {copiedEmail ? (
                      <Check id="cop" className="w-4 h-4 text-emerald-400" />
                    ) : (
                      <Copy id="cop-raw" className="w-4 h-4" />
                    )}
                  </button>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-zinc-150 font-bold hover:text-emerald-450 transition-colors text-sm"
                    >
                      {PERSONAL_INFO.phone}
                    </a>
                  </div>
              ...
              <div className="relative z-10 space-y-6">
                <div className="flex justify-between items-center pb-4 border-b border-zinc-850/60">
                  <div className="space-y-0.5">
                    <span className="text-[10px] font-mono tracking-widest text-[#10B981] font-bold uppercase animate-pulse">
                      Scan & Connect
                    </span>
                ...
                <div className="space-y-1">
                  <p className="text-[11px] font-mono text-zinc-500 uppercase leading-none">
                    CONTACT TARGET
                  </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    id="vcard-dn-btn"
                    className="grow flex items-center justify-center gap-2 px-5 py-3.5 bg-zinc-100 hover:bg-white text-black font-semibold text-sm rounded-xl transition-all duration-150 shadow-md group/btn cursor-pointer"
                  >
                    <Download
                      id="vcard-dn-icon"
                      className="w-4 h-4 text-black group-hover/btn:translate-y-0.5 transition-transform"
                    />
            ...
            <form onSubmit={handleFormSubmit} className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-1.5">
                  <label
                    htmlFor="name-input"
                    className="text-xs font-bold text-zinc-500 font-mono uppercase tracking-wider"
                  >
                    Your Name
                  </label>
              ...
              <AnimatePresence mode="wait">
                {submitSuccess ? (
                  ...
                  >
                    ...
                    />
                    <span>
                      Message logged securely in browser state! Praise will
                      retrieve it. Thanks!
                    </span>
                  </motion.div>
                ) : null}
            ...
            >
              ...
              <div className="space-y-1.5 relative">
                ...
                <p className="text-xs text-zinc-400">
                  Share or load this portfolio instantly on any camera device
                </p>
              </div>
              ...
              <div className="space-y-3 font-sans">
                ...
                <p className="text-[11px] text-zinc-450 leading-relaxed">
                  Point your phone's camera at the QR code above to instantly
                  open and save this live portfolio website directly.
                </p>
              </div>
            ...
            >
              ...
              <div className="relative pb-4 border-b border-zinc-900 text-left">
                <h4
                  ...
                  className="text-lg font-extrabold text-white tracking-tight flex items-center gap-2"
                >
                  <span className="p-1 px-2.5 bg-emerald-500/10 text-emerald-400 rounded-lg text-xs font-mono font-bold tracking-widest uppercase">
                    Contact Card Preview
                  </span>
                </h4>
                <p className="text-xs text-zinc-400 mt-1">
                  A visual representation of your downloadable contact profile.
                </p>
              </div>

              {/* Skeuomorphic Premium Card Representation */}
              <div className="w-full p-6 bg-linear-to-br from-zinc-900 to-zinc-950 border border-zinc-850 rounded-2xl shadow-xl relative overflow-hidden flex flex-col justify-between min-h-40 text-left">
                {/* Visual Accent */}
                <div className="absolute -top-10 -right-10 w-36 h-36 bg-linear-to-br from-emerald-500/10 to-teal-500/5 rounded-full blur-2xl pointer-events-none" />
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs font-mono text-emerald-400 font-bold uppercase tracking-widest leading-none mt-1">
                      {PERSONAL_INFO.title}
                    </p>
                  </div>

                  {/* Monogram emblem */}
                  <div className="w-10 h-10 rounded-xl bg-zinc-950/80 border border-zinc-800 flex items-center justify-center shrink-0">
                ...
                <div className="mt-8 pt-4 border-t border-zinc-850/50 grid grid-cols-1 gap-y-3 font-sans text-xs text-zinc-300">
                  <div className="flex items-center gap-2 min-w-0">
                    <Mail className="w-3.5 h-3.5 text-emerald-405 shrink-0" />
                    <span
                  ...
                  <div className="flex items-center gap-2 min-w-0">
                    <Phone className="w-3.5 h-3.5 text-emerald-405 shrink-0" />
                    <span className="select-all truncate">
                      {PERSONAL_INFO.phone}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 min-w-0">
                    <MapPin className="w-3.5 h-3.5 text-emerald-405 shrink-0" />
              ...
              <div className="flex gap-3">
                <button
                  onClick={downloadVCard}
                  className="grow flex items-center justify-center gap-2 py-3 bg-zinc-100 hover:bg-white text-black font-extrabold text-xs rounded-xl transition-all duration-150 shadow-md cursor-pointer"
                >
